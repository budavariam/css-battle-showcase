    ...
    <Layout customMeta={customMeta}>
      <article>
        ...
        <p className="mb-3 text-sm text-gray-500 dark:text-gray-400">
          I solved it on {format(parseISO(frontMatter.date), 'MMMM d, yyyy')}. You can try to beat my record on <a href={`https://cssbattle.dev/play/${numOfItem}`} target="_blank" rel="noopener noreferrer">CSSBattle</a>!
        </p>
